...
public class WebAPI {
    ...
    {
        String APIkey = "34e7a81be4530b164136dcc6d4193798";
    ...
    public static void parseJSON(String json, ArrayList<Movie> movies)
    {
        ...
        for (int i = 0; i < movieList.length(); i++)
        {
            ...
            boolean movievideo = movieObj.getBoolean("video");
            int votecount = movieObj.getInt("vote_count");

            String fullPosterPath = "https://image.tmdb.org/t/p/w500" + posterPath;
            Movie movie = new Movie(movieTitle, movieID, fullPosterPath,movievideo, votecount, isadult);
